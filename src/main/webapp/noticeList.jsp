...
<div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">公告管理</strong><small></small></div>
    </div>

    <hr>
    <form action="${pageContext.request.contextPath}/notice/page.html" method="post" id="pageForm">
        <input type="hidden" name="currentPage" value="${page.currentPage}" id="currentPage">
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="${pageContext.request.contextPath}/noticeAdd.jsp" class="am-btn am-btn-default"><i
            ...
            <div class="am-u-sm-12 am-u-md-3">
                <div class="am-input-group am-input-group-sm">
                    <input type="text" value="${page.params.noticeTitle}" placeholder="公告标题"
                           name="params[noticeTitle]" class="am-form-field">
                        ...
                        <c:forEach items="${page.list}" var="notice">
                            <tr>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="javascript:void(0);" onclick="readMessage('${notice.noticeId}')"
                                               class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                    class="am-icon-pencil-square-o"></span> 查看
                                            </a>
                                            <a href="${pageContext.request.contextPath}/notice/toEdit.html?id=${notice.noticeId}"
                                               class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                    class="am-icon-pencil-square-o"></span> 编辑
                                            </a>
                                            <a href="${pageContext.request.contextPath}/notice/delete.html?id=${notice.noticeId}"
