...
<div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改公告</strong>
            <small></small>
        </div>
    </div>
            ...
            <div class="admin-content-body">
                <div class="am-g">
                    <form class="am-form am-form-horizontal" id="form"
                          action="${pageContext.request.contextPath}/notice/edit.html" method="post"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <input id="roleName" required="" placeholder="请输入公告标题" value="${notice.noticeTitle}"
                                       name="noticeTitle"
                                       type="text">
                            </div>
                        </div>
