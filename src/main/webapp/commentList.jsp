...
<div class="admin-content-body">
    ...
    <hr>
    <form action="${pageContext.request.contextPath}/comment/page.html" method="post" id="pageForm">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-3">
                <div class="am-input-group am-input-group-sm">
                    <input type="text" value="${page.params.commentUser}" placeholder="发布人" name="params[commentUser]"
                           class="am-form-field">
            ...
            <div class="am-u-sm-12">
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        <thead>
                        <tr>
                            <th class="table-title">评论者</th>
                            <th class="table-title">帖子</th>
                        ...
                        <c:forEach items="${page.list}" var="comment">
                            <tr>
                                ...
                                <td>${comment.article.articleTitle}</td>
                                <td>${comment.commentGood}</td>
                                <td>${comment.commentTime}</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="javascript:void(0)" onclick="readMessage('${comment.commentId}')"
                                               class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                    class="am-icon-pencil-square-o"></span> 查看
                                            </a>
                                            <a href="${pageContext.request.contextPath}/comment/delete.html?id=${comment.commentId}"
...
<script>
    ...
    function readMessage(id) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/comment/getById.action",
            data: "{\"commentId\": \"" + id + "\"}",
            contentType: "application/json;charset=UTF-8",
            type: "post",
            dataType: "json",
            success: function (dep) {
                layer.alert(dep.commentContent)
            }
        });
